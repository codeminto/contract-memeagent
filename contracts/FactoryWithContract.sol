...
contract FactoryContract {
    ...
    event CompetitionCreated(address indexed competitionContract, address indexed creator);

    constructor(uint256 _competitionCreationFee) {
    ...
    function createCompetition(
        ...
        address competitionContract = address(new CompetitionContract(
            msg.sender,
            _title,
            _startDate,
            _endDate,
            ...
            _totalPrize,
            _totalWinners,
            _competitionCreationFee
        ));
        emit CompetitionCreated(competitionContract, msg.sender);
    }
}
